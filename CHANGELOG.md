...
- **1386 tests across 19 suites** (was 1361). `tests/test_report.py` +19 (#9 A/B shapes, env-reads with trailing terminators, redaction parity, over-correction guards); `hooks/test_fp_fixes.py` +6 (FP-FIX 6). Token pattern-sync 10/10.

### Docs

- New `docs/history/report-entropy-fp-2026-06-20.md` (issue #9 resolution + audit notes). `docs/block-secrets-false-positives.md` and `docs/hooks.md` updated with the additional benign carve-outs.
