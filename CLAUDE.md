...
| 12-dimension project audit (2 H, 8 M, 13 L, 9 I) | 2026-05-22 | H1 closed in v1.1.2 (Ship A); H2 + M4 + M5 + #758 closed in v1.2.0 (Ship B); M6 + M7 + M8 + L2 + L10 + L11 + L12 closed in v1.2.1 (Ship C); M1 + M2 deferred | [`docs/history/audit-2026-05-22.md`](docs/history/audit-2026-05-22.md) |
