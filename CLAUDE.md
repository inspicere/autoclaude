...
No dependencies beyond Python 3.11+ stdlib. Test suites: `tests/test_report.py` (467 tests for the main script's pure functions), `hooks/test_block_secrets.py` (76 tests), `hooks/test_bypass_fixes.py` (110 tests), `hooks/test_round2_bypass_fixes.py` (50 tests), `hooks/test_round3_bypass_fixes.py` (82 tests), `hooks/test_analysis_fixes.py` (68 tests), `hooks/test_fp_fixes.py` (52 tests), `hooks/test_infra_usability.py` (139 tests), `hooks/test_warn_secrets.py` (15 tests), `hooks/test_warn_mode.py` (39 tests), `hooks/test_warn_output_adversarial.py` (48 tests), `hooks/test_phase1_audit_fixes.py` (31 tests), `hooks/test_round4_bypass_fixes.py` (26 tests), `hooks/test_phase3_audit_fixes.py` (20 tests), `hooks/test_phase4_audit_fixes.py` (78 tests), `hooks/test_phase5_audit_fixes.py` (24 tests), `hooks/test_phase6_audit_fixes.py` (17 tests), `hooks/test_phase7_audit_fixes.py` (9 tests), `scripts/check-pattern-sync.py` (10 checks) — 1361 total across 19 suites.
