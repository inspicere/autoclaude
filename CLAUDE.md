...
1. **`test.yml`** — runs all 15 test suites (1092 tests). Results uploaded to DefectDojo as "Generic Findings Import" under engagement "CI Tests". Clean runs auto-close previous findings via `close_old_findings=true`.
